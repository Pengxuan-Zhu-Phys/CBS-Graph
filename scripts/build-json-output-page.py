...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    svg .unit-number { fill:var(--ink); font:600 12px var(--font-mono); }
    ...
    .unit-title code { font-size:14px; }
...
<main class="frame">
  ...
  <p class="backlink"><span class="lbl">context</span><span>This page expands <a href="cbs-change-ledger.html#6">slide 6 of the CBS change-ledger deck &#8599;</a> &mdash; <em>Results became a data contract</em>. The deck says the contract exists; this page says what is actually in it.</span></p>
  ...
  <p class="backlink"><span class="lbl">return</span><span>Back to <a href="cbs-change-ledger.html#6">the change-ledger deck &#183; slide 6 &#8599;</a>, or across to the <a href="cbs-solo-comparison.html#unit-4">entrypoint's output contract change &#8599;</a> that introduced this file.</span></p>
