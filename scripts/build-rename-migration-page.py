...
<main class="frame">
  ...
  <p class="backlink"><span class="lbl">context</span><span>This page expands <a href="cbs-change-ledger.html#9">slide 8 of the CBS change-ledger deck &#8599;</a>, which summarises the migration in one card. Everything below is read from the worktree at generation time.</span></p>
  ...
  <p class="backlink" style="margin-top:26px"><span class="lbl">back</span><span>Return to <a href="cbs-change-ledger.html#9">slide 8 &#8599;</a>, or to the <a href="cbs-change-ledger.html#1">start of the deck &#8599;</a>.</span></p>
