...
<main class="frame">
  ...
  <p class="backlink"><span class="lbl">context</span><span>This page is the build-system half of <a href="cbs-change-ledger.html#9">slide 9 of the CBS change-ledger deck &#8599;</a> &mdash; <em>Variable-R jets, threaded end to end</em>. That slide follows a VR jet through the physics; this one explains what had to change in CMake before <code>-lVariableR</code> could exist.</span></p>
  ...
  <p class="backlink"><span class="lbl">return</span><span>Back to <a href="cbs-change-ledger.html#9">the change-ledger deck &#183; slide 9 &#8599;</a>, or across to the <a href="cbs-json-output.html">JSON output contract &#8599;</a> and the <a href="cbs-solo-comparison.html">focused solo.cpp comparison &#8599;</a>.</span></p>
