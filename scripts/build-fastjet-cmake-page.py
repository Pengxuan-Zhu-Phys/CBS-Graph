...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    svg .node .title { fill:var(--ink); font:600 13px var(--font-mono); }
    svg .node .body { fill:var(--muted); font:9.5px var(--font-mono); }
    ...
    .unit-hunks { margin:0; padding:12px 0; overflow-x:auto; font:11px/1.65 var(--font-mono); background:#fff; border:0; }
    ...
    details.full summary { cursor:pointer; color:var(--ink); font:11px var(--font-mono); padding:12px 0; }
    pre.full { background:#fff; border:1px solid var(--rule); color:var(--ink); font:10px/1.45 var(--font-mono); margin:0; max-height:720px; overflow:auto; padding:16px; white-space:pre; }
...
<main class="frame">
  ...
  <p class="backlink"><span class="lbl">context</span><span>This page is the build-system half of <a href="cbs-change-ledger.html#10">slide 9 of the CBS change-ledger deck &#8599;</a> &mdash; <em>Variable-R jets, threaded end to end</em>. That slide follows a VR jet through the physics; this one explains what had to change in CMake before <code>-lVariableR</code> could exist.</span></p>
  ...
  <p class="backlink"><span class="lbl">return</span><span>Back to <a href="cbs-change-ledger.html#10">the change-ledger deck &#183; slide 9 &#8599;</a>, or across to the <a href="cbs-json-output.html">JSON output contract &#8599;</a> and the <a href="cbs-solo-comparison.html">focused solo.cpp comparison &#8599;</a>.</span></p>
